...
const SubmitDirectProposalPageContent: React.FC<SubmitDirectProposalPageContentProps> = ({ categories, segData}) => {
        ...
        <Col lg={10} >
          <Form onSubmit={formik.handleSubmit}>
            <Form.Group controlId="submitIdeaCategory">
              <h3 className="border-bottom mb-3">Direct Proposal Details</h3>
            ...
            <Form.Group>
                  ...
                  <ImageUploader name="imagePath" fileContainerStyle={{backgroundColor: "#F8F9FA"}}withPreview={true} onChange={(picture)=>{
                    ...
                    console.log(picture);
                    }} imgExtension={['.jpg','.jpeg','.png','.webp']} buttonText="Select Proposal Image" maxFileSize={10485760} label={"Max file size 10mb, \n jpg, jpeg, png, webp"} singleImage={true}/>
            </Form.Group>
            <Form.Group>
            ...
            <Form.Group>
              ...
              <h3  className="border-bottom mb-3">Community Solicitation</h3>
                  <div className="topping">
                    <input type="checkbox" id="123" name="topping" value="Paneer" />
                    <Form.Label>&nbsp;&nbsp;Project Team/Collaborators</Form.Label> <br />
                    <input type="checkbox" id="234" name="topping" value="Paneer" />
                    <Form.Label>&nbsp;&nbsp;Volunteers</Form.Label> <br />
                    <input type="checkbox" id="345" name="topping" value="Paneer" />
                    <Form.Label>&nbsp;&nbsp;Material donors</Form.Label> <br />
                    <input type="checkbox" id="456" name="topping" value="Paneer" />
                    <Form.Label>&nbsp;&nbsp;Idea suggestion</Form.Label> <br />
                    <input type="checkbox" id="567" name="topping" value="Paneer" />
                    <Form.Label>&nbsp;&nbsp;Specific Feedback</Form.Label> <br />
                    <input type="checkbox" id="678" name="topping" value="Paneer" />
