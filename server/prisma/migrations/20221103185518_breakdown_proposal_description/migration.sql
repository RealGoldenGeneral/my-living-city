/*
  ...
  - Added the required column `proposal_requirements` to the `idea` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "proposal_requirements" TEXT NOT NULL,
