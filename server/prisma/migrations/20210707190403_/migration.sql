/*
  ...
  - The values [NORMAL] on the enum `user_type` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE "user" ALTER COLUMN "user_type" SET DEFAULT E'RESIDENTIAL';

-- AlterTable
ALTER TABLE "user_address" ADD COLUMN     "banned" BOOLEAN NOT NULL DEFAULT false;
